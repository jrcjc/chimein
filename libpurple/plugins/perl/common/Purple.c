...
#endif
    if (items < 3 || items > 4)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::timeout_add", "plugin, seconds, callback, data = 0");
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::timeout_remove", "handle");
    PERL_UNUSED_VAR(cv); /* -W */
    {
...
#endif
    if (items != 0)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::deinit", "");
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 107 "Purple.xs"
...
#endif
    if (items != 0)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::get_core", "");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Core	RETVAL;
