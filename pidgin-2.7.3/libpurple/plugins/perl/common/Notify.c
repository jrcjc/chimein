...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Notify::close", "type, ui_handle");
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Notify::close_with_handle", "handle");
    PERL_UNUSED_VAR(cv); /* -W */
    {
...
#endif
    if (items != 7)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Notify::email", "handle, subject, from, to, url, cb, user_data");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	void *	handle = INT2PTR(void *,SvIV(ST(0)));
...
#endif
    if (items != 9)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Notify::emails", "handle, count, detailed, subjects, froms, tos, urls, cb, user_data");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	void *	handle = INT2PTR(void *,SvIV(ST(0)));
...
#endif
    if (items != 7)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Notify::formatted", "handle, title, primary, secondary, text, cb, user_data");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	void *	handle = INT2PTR(void *,SvIV(ST(0)));
...
#endif
    if (items != 5)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Notify::userinfo", "gc, who, user_info, cb, user_data");
    PERL_UNUSED_VAR(cv); /* -W */
    {
...
#endif
    if (items != 7)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Notify::message", "handle, type, title, primary, secondary, cb, user_data");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	void *	handle = INT2PTR(void *,SvIV(ST(0)));
...
#endif
    if (items != 7)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Notify::searchresults", "gc, title, primary, secondary, results, cb, user_data");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Connection	gc = purple_perl_ref_object(ST(0));
	const char *	title = (const char *)SvPV_nolen(ST(1));
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Notify::uri", "handle, uri");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	void *	handle = INT2PTR(void *,SvIV(ST(0)));
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::NotifyUserInfo::new", "class");
    PERL_UNUSED_VAR(cv); /* -W */
    {
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::NotifyUserInfo::destroy", "user_info");
    PERL_UNUSED_VAR(cv); /* -W */
    {
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::NotifyUserInfo::get_entries", "user_info");
    PERL_UNUSED_VAR(cv); /* -W */
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::NotifyUserInfo::get_text_with_newline", "user_info, newline");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__NotifyUserInfo	user_info = purple_perl_ref_object(ST(0));
...
#endif
    if (items != 3)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::NotifyUserInfo::add_pair", "user_info, label, value");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__NotifyUserInfo	user_info = purple_perl_ref_object(ST(0));
...
#endif
    if (items != 3)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::NotifyUserInfo::prepend_pair", "user_info, label, value");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__NotifyUserInfo	user_info = purple_perl_ref_object(ST(0));
	const char *	label = (const char *)SvPV_nolen(ST(1));
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::NotifyUserInfo::add_section_break", "user_info");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__NotifyUserInfo	user_info = purple_perl_ref_object(ST(0));
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::NotifyUserInfo::add_section_header", "user_info, label");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__NotifyUserInfo	user_info = purple_perl_ref_object(ST(0));
	const char *	label = (const char *)SvPV_nolen(ST(1));
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::NotifyUserInfo::remove_last_item", "user_info");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__NotifyUserInfo	user_info = purple_perl_ref_object(ST(0));
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::NotifyUserInfo::entry_get_label", "user_info_entry");
    PERL_UNUSED_VAR(cv); /* -W */
    {
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::NotifyUserInfo::entry_get_value", "user_info_entry");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__NotifyUserInfoEntry	user_info_entry = purple_perl_ref_object(ST(0));
	const gchar *	RETVAL;
