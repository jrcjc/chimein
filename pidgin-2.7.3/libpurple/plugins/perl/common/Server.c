...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Serv::add_deny", "con, a");
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Serv::add_permit", "a, b");
    PERL_UNUSED_VAR(cv); /* -W */
    {
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Serv::alias_buddy", "buddy");
    PERL_UNUSED_VAR(cv); /* -W */
    {
...
#endif
    if (items != 4)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Serv::chat_invite", "con, a, b, c");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Connection	con = purple_perl_ref_object(ST(0));
	int	a = (int)SvIV(ST(1));
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Serv::chat_leave", "a, b");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Connection	a = purple_perl_ref_object(ST(0));
	int	b = (int)SvIV(ST(1));
...
#endif
    if (items != 4)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Serv::chat_send", "con, a, b, flags");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Connection	con = purple_perl_ref_object(ST(0));
	int	a = (int)SvIV(ST(1));
...
#endif
    if (items != 4)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Serv::chat_whisper", "con, a, b, c");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Connection	con = purple_perl_ref_object(ST(0));
	int	a = (int)SvIV(ST(1));
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Serv::get_info", "con, a");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Connection	con = purple_perl_ref_object(ST(0));
	const char *	a = (const char *)SvPV_nolen(ST(1));
...
#endif
    if (items != 3)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Serv::got_alias", "gc, who, alias");
    PERL_UNUSED_VAR(cv); /* -W */
    {
...
#endif
    if (items != 6)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Serv::got_chat_in", "g, id, who, chatflags, message, mtime");
    PERL_UNUSED_VAR(cv); /* -W */
    {
...
#endif
    if (items != 5)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Serv::got_chat_invite", "gc, name, who, message, components");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Connection	gc = purple_perl_ref_object(ST(0));
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Serv::got_chat_left", "g, id");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Connection	g = purple_perl_ref_object(ST(0));
	int	id = (int)SvIV(ST(1));
...
#endif
    if (items != 5)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Serv::got_im", "gc, who, msg, imflags, mtime");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Connection	gc = purple_perl_ref_object(ST(0));
	const char *	who = (const char *)SvPV_nolen(ST(1));
...
#endif
    if (items != 3)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Serv::got_joined_chat", "gc, id, name");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Connection	gc = purple_perl_ref_object(ST(0));
	int	id = (int)SvIV(ST(1));
...
#endif
    if (items != 4)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Serv::got_typing", "gc, name, timeout, state");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Connection	gc = purple_perl_ref_object(ST(0));
	const char *	name = (const char *)SvPV_nolen(ST(1));
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Serv::got_typing_stopped", "gc, name");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Connection	gc = purple_perl_ref_object(ST(0));
	const char *	name = (const char *)SvPV_nolen(ST(1));
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Serv::join_chat", "conn, components");
    PERL_UNUSED_VAR(cv); /* -W */
    {
...
#endif
    if (items != 3)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Serv::move_buddy", "buddy, group1, group2");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__BuddyList__Buddy	buddy = purple_perl_ref_object(ST(0));
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Serv::reject_chat", "con, components");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Connection	con = purple_perl_ref_object(ST(0));
	SV *	components = ST(1);
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Serv::rem_deny", "con, a");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Connection	con = purple_perl_ref_object(ST(0));
	const char *	a = (const char *)SvPV_nolen(ST(1));
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Serv::rem_permit", "con, a");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Connection	con = purple_perl_ref_object(ST(0));
	const char *	a = (const char *)SvPV_nolen(ST(1));
...
#endif
    if (items != 3)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Serv::send_file", "gc, who, file");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Connection	gc = purple_perl_ref_object(ST(0));
	const char *	who = (const char *)SvPV_nolen(ST(1));
...
#endif
    if (items != 4)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Serv::send_im", "con, a, b, flags");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Connection	con = purple_perl_ref_object(ST(0));
	const char *	a = (const char *)SvPV_nolen(ST(1));
...
#endif
    if (items != 3)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Serv::send_typing", "con, a, state");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Connection	con = purple_perl_ref_object(ST(0));
	const char *	a = (const char *)SvPV_nolen(ST(1));
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Serv::set_info", "con, a");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Connection	con = purple_perl_ref_object(ST(0));
	const char *	a = (const char *)SvPV_nolen(ST(1));
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Serv::set_permit_deny", "con");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Connection	con = purple_perl_ref_object(ST(0));
