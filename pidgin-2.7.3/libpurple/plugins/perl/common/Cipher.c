...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Cipher::get_name", "cipher");
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Cipher::get_capabilities", "cipher");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Cipher	cipher = purple_perl_ref_object(ST(0));
	guint	RETVAL;
...
#endif
    if (items != 4)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Cipher::digest_region", "name, data_sv, in_len, digest");
    PERL_UNUSED_VAR(cv); /* -W */
    {
...
#endif
    if (items != 9)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Cipher::http_digest_calculate_response", "algorithm, method, digest_uri, qop, entity, nonce, nonce_count, client_nonce, session_key");
    PERL_UNUSED_VAR(cv); /* -W */
    {
...
#endif
    if (items != 6)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Cipher::http_digest_calculate_session_key", "algorithm, username, realm, password, nonce, client_nonce");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	const gchar*	algorithm = (const gchar *)SvPV_nolen(ST(0));
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Ciphers::find_cipher", "name");
    PERL_UNUSED_VAR(cv); /* -W */
    {
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Ciphers::register_cipher", "name, ops");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	gchar *	name = (gchar *)SvPV_nolen(ST(0));
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Ciphers::unregister_cipher", "cipher");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Cipher	cipher = purple_perl_ref_object(ST(0));
	gboolean	RETVAL;
...
#endif
    if (items != 0)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Ciphers::get_ciphers", "");
    PERL_UNUSED_VAR(cv); /* -W */
...
#endif
    if (items != 0)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Ciphers::get_handle", "");
    PERL_UNUSED_VAR(cv); /* -W */
    {
...
#endif
    if (items != 3)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Cipher::Context::set_option", "context, name, value");
    PERL_UNUSED_VAR(cv); /* -W */
    {
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Cipher::Context::get_option", "context, name");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Cipher__Context	context = purple_perl_ref_object(ST(0));
	gchar *	name = (gchar *)SvPV_nolen(ST(1));
...
#endif
    if (items < 2 || items > 3)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Cipher::Context::new", "klass, cipher, extra = NULL");
    PERL_UNUSED_VAR(cv); /* -W */
    {
...
#endif
    if (items < 2 || items > 3)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Cipher::Context::new_by_name", "klass, name, extra = NULL");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	gchar *	name = (gchar *)SvPV_nolen(ST(1));
	void *	extra;
...
#endif
    if (items < 1 || items > 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Cipher::Context::reset", "context, extra = NULL");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Cipher__Context	context = purple_perl_ref_object(ST(0));
	gpointer	extra;
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Cipher::Context::destroy", "context");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Cipher__Context	context = purple_perl_ref_object(ST(0));
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Cipher::Context::set_iv", "context, iv");
    PERL_UNUSED_VAR(cv); /* -W */
    {
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Cipher::Context::append", "context, data");
    PERL_UNUSED_VAR(cv); /* -W */
    {
...
#endif
    if (items != 3)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Cipher::Context::digest", "context, in_len, digest");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Cipher__Context	context = purple_perl_ref_object(ST(0));
...
#endif
    if (items != 3)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Cipher::Context::digest_to_str", "context, in_len, digest_s");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Cipher__Context	context = purple_perl_ref_object(ST(0));
	size_t	in_len = (size_t)SvUV(ST(1));
...
#endif
    if (items != 3)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Cipher::Context::encrypt", "context, data_sv, output");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Cipher__Context	context = purple_perl_ref_object(ST(0));
	SV *	data_sv = ST(1);
...
#endif
    if (items != 3)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Cipher::Context::decrypt", "context, data_sv, output");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Cipher__Context	context = purple_perl_ref_object(ST(0));
	SV *	data_sv = ST(1);
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Cipher::Context::set_salt", "context, salt");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Cipher__Context	context = purple_perl_ref_object(ST(0));
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Cipher::Context::get_salt_size", "context");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Cipher__Context	context = purple_perl_ref_object(ST(0));
	size_t	RETVAL;
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Cipher::Context::set_key", "context, key");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Cipher__Context	context = purple_perl_ref_object(ST(0));
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Cipher::Context::get_key_size", "context");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Cipher__Context	context = purple_perl_ref_object(ST(0));
	size_t	RETVAL;
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Cipher::Context::set_data", "context, data");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Cipher__Context	context = purple_perl_ref_object(ST(0));
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Cipher::Context::get_data", "context");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Cipher__Context	context = purple_perl_ref_object(ST(0));
	gpointer	RETVAL;
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Cipher::Context::get_batch_mode", "context");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Cipher__Context	context = purple_perl_ref_object(ST(0));
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Cipher::Context::get_block_size", "context");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Cipher__Context	context = purple_perl_ref_object(ST(0));
	size_t	RETVAL;
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Cipher::Context::set_batch_mode", "context, mode");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Purple__Cipher__Context	context = purple_perl_ref_object(ST(0));
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Purple::Cipher::Context::set_key_with_len", "context, key");
    PERL_UNUSED_VAR(cv); /* -W */
    {
