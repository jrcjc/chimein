...
/* configure arguments */
#define CONFIG_ARGS " '--disable-gtkui' '--disable-screensaver' '--disable-consoleui' '--disable-sm' '--disable-perl' '--disable-tk' '--disable-tcl' '--disable-gstreamer' '--disable-schemas-install' '--disable-gestures' '--disable-cap' '--disable-gevolution' '--disable-gtkspell' '--disable-startup-notification' '--with-gnutls-includes=/opt/local/include/' '--with-gnutls-libs=/opt/local/lib/' '--disable-vv' '--disable-meanwhile' '--disable-nm' '--disable-dbus'"
